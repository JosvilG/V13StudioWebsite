        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <ScrollReveal>
            <div className="relative">
              <div className="aspect-square relative border border-border p-8 md:p-12">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {team.map((member, i) => (
                      <ScrollReveal key={member.role} delay={i * 100 + 200}>
                        <div className="group p-4 border border-border hover:border-primary/50 transition-all duration-500 cursor-pointer">
                          <div
              ...
              <ScrollReveal delay={400}>
                <div className="absolute -bottom-8 -right-8 px-6 py-4 bg-background border border-border">
